...
deno run --no-prompt --allow-read=$DENO_CACHE,$WASMBUILD,dist,./ --allow-write=$DENO_CACHE,$WASMBUILD,dist --allow-run=$NPM --allow-env=HOME,DENO_DIR,DENO_AUTH_TOKENS,XDG_DATA_HOME,XDG_CACHE_HOME --allow-net ./dev/build-distribution.ts
